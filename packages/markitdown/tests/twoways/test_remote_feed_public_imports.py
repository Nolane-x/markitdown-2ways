...
def test_h20_feed_reader_symbol_is_public_without_writer_exports() -> None:
    ...
    for module in (remote, readers, tw):
        assert hasattr(module, "read_remote_feed_snapshot_ir")
        assert "read_remote_feed_snapshot_ir" in module.__all__

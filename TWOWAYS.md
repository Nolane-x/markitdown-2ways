...
H18-H27 derived text is likewise inspection-only and explicitly derived; these nodes
...
only native MP3 authority and adding no WAV/M4A/MP4 writer. H25/H26/H27 then bind the unchanged ImageConverter, OutlookMsgConverter and PdfConverter derived semantic projections without creating new native write authority. The one-way
